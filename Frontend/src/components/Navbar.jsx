...
export default function Navbar() {
    ...
    }, [theme]);//this ensures that the effect only runs when `theme` is updated, not after every render.
        ...
        <div className="navbar">
            ...
            <div className="navbar-end">
                ...
                </div>
                {
                    authUser?(<Logout/>):
                    (<div className="ml-2">
                    <a className="btn bg-black text-white px-2 rounded-md hover:bg-slate-600 duration-300" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
                    <Login/>
                    </div>)
                }
            </div>
